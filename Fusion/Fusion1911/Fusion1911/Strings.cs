...
namespace Fusion1911
{
    public static class STRINGS
    {
        ...
        public const string _EXITMESSAGE = "REEEE";
        ...
        public const string _GAMECREATE_GOOD_SWITCHDATABASE = "Successfully switched to {0}DB!";
        public const string _GAMECREATE_BAD_SWITCHDATABASE = "Couldn't switch to {0}DB!";
        ...
        public const string _GAMECREATE_BAD_SETPOINTER = "Couldn't set to pointer (requires index) !";
        ...
        // database commands
        public const string _COMMAND_SAVEDB = "/WriteDB {0}";
        public const string _COMMAND_LOADDB = "/ReadDB {0}";
        public const string _COMMAND_ADDDB = "/AddToDB {0}";
        public const string _COMMAND_REMOVEDB = "/RemoveFromDB {0}";
        public const string _COMMAND_FINDDB = "/FindInDB {0}";
        public const string _COMMAND_SETDB = "/SetOnDB {0}";

        public static readonly List<string> _COMMAND_ALLDB = new List<string>(){ "-a", "ALL", "--all", "/A", "/a" };
        ...
        public const string _GAMECREATE_GOOD_DBSWITCH = "Database successfully switched to {0}DB";
        public const string _GAMECREATE_BAD_DBSWITCH = "Couldn't switch to that DB!";

        public const string _GAMECREATE_GOOD_DBHLOAD = "Main database handler loaded up!";
        public const string _GAMECREATE_BAD_DBHLOAD = "Main database handler malfunction, stopping...";
