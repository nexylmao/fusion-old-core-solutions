    ...
    public class Levels
    {
        ...
        public Return CheckLevelUp()
        {
            ...
            if (Experience >= expforlvlup && LevelValue < MaxLevel)
            {
                ...
                return new Return(STRINGS._MESSAGE_LEVELUP,nameof(STRINGS._MESSAGE_LEVELUP));
            }
        ...
        public Return RewardExperience(UInt64 a)
        {
            if(a != 0 && LevelValue < MaxLevel)
            {
                ...
                return new Return(_MESSAGE_EXP,nameof(_MESSAGE_EXP));
            }
            if(LevelValue == MaxLevel)
            {
                Experience = 0;
