...
namespace Fusion
{
    ...
    public class Stats
    {
        ...
        public ReturnValue ChangeStat(UInt64 value, byte stat)
        {
            try
            {
                Values[stat] = value;
                string _GAMECREATE_GOOD_STATCHANGED = string.Format(STRINGS._GAMECREATE_GOOD_STATCHANGED, GetStatName(stat), value);
                return new ReturnValue(_GAMECREATE_GOOD_STATCHANGED, nameof(_GAMECREATE_GOOD_STATCHANGED));
            }
            catch
            {
                return new ReturnValue(STRINGS._GAMECREATE_BAD_COULDNTCHANGESTAT, nameof(STRINGS._GAMECREATE_BAD_COULDNTCHANGESTAT));
            }
        }
    ...
    public class Bag
    {
        ...
        public ReturnValue EquipItem(Item i)
        {
            ...
            {
                return new ReturnValue(STRINGS._MESSAGE_BAD_EQUIPNULLITEM, nameof(STRINGS._MESSAGE_BAD_EQUIPNULLITEM));
            }
        }
        #endregion
    ...
    public class LootTable
    {
        ...
        public ReturnValue AddItem(Item item, float chance)
        {
            try
            {
                ...
                return new ReturnValue(_GAMECREATE_GOOD_ADDITEMLOOT,nameof(_GAMECREATE_GOOD_ADDITEMLOOT));
            }
            catch
            {
                return new ReturnValue(STRINGS._GAMECREATE_BAD_ADDITEMLOOT, nameof(STRINGS._GAMECREATE_BAD_ADDITEMLOOT));
            }
        }
        public ReturnValue ChangeItemChance(Item item, float newchance)
        {
            try
            {
                ...
                return new ReturnValue(_GAMECREATE_BAD_ITEMLOOTCHANCECHANGE, nameof(_GAMECREATE_BAD_ITEMLOOTCHANCECHANGE));
            }
            catch
            {
                return new ReturnValue(STRINGS._GAMECREATE_BAD_ITEMLOOTCHANCECHANGE, nameof(STRINGS._GAMECREATE_BAD_ITEMLOOTCHANCECHANGE));
            }
        }
        public ReturnValue DeleteItem(Item item)
        {
            try
            {
                ...
                return new ReturnValue(_GAMECREATE_GOOD_DELETEITEMLOOT, nameof(_GAMECREATE_GOOD_DELETEITEMLOOT));
            }
            catch
            {
                return new ReturnValue(STRINGS._GAMECREATE_BAD_DELETEITEMLOOT, nameof(STRINGS._GAMECREATE_BAD_DELETEITEMLOOT));
            }
        }
